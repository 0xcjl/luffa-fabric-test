...
1. [MVP 新框架梳理：链下执行，链上可验证，链上价值执行](./LAEL_MVP_NEW_FRAMEWORK_OVERVIEW_2026-05-28.zh.md)
2. [新框架文档与实施计划](./LAEL_FRAMEWORK_DOCS_IMPLEMENTATION_PLAN_2026-05-28.zh.md)
3. [完整需求文档 zh](./LAEL_REQUIREMENTS_v0.3.zh.md) / [en](./LAEL_REQUIREMENTS_v0.3.en.md)
4. [MVP 文档 zh](./LAEL_MVP_v0.3.zh.md) / [en](./LAEL_MVP_v0.3.en.md)
5. [测试方案 zh](./LAEL_TEST_PLAN_v0.3.zh.md) / [en](./LAEL_TEST_PLAN_v0.3.en.md)
